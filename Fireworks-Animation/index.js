...
class Canvas extends CanvasOption {
    ...
    createParticles(x, y, colorDeg) {
        ...
        for (let i = 0; i < PARTICLE_NUMBER; i++) {
            const r =
                ...
                hypotenuse(innerWidth, innerHeight) * // 화면사이즈를 바꿨을때 알맞은 폭죽 사이즈를 위해 피타고라스 공식씀
                0.0001;
    ...
    render() {
        ...
        const frame = () => {
            ...
            // #00000010 = rgba(0, 0, 0, 10), 저 마지막 알파값을 더해서 잔상이 남게해해서 떨어지는 것 같이 보이게해줌
            ...
            this.particles.forEach((particle, index) => {
                ...
                if (Math.random() < 0.1) {
                    this.sparks.push(
                        new Spark(particle.x, particle.y, 0, 0, 0.4, 45)
                    );
                }
